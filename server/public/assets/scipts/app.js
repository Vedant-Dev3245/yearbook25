...
// console.image(
//   "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fmedia.giphy.com%2Fmedia%2FVuw9m5wXviFIQ%2Fgiphy.gif&f=1&nofb=1"
// );

$(".comment-box").scroll(function () {
  if (
    $(this).scrollTop() + $(this).innerHeight() >=
    $(this)[0].scrollHeight / 1.4
  ) {
    $(".c5").addClass("nono");
    $(".c6").addClass("nono");
  }
...
document.querySelector(".dark-mode-container").addEventListener("click", () => {
  ...
  document.querySelector(
    ".dark-mode-container"
  ).style.backgroundColor = `${usedTheme.commentBackground}`;
  document.querySelector(
    ".developer-container"
  ).style.backgroundColor = `${usedTheme.commentBackground}`;
