...
export default function Walkthrough() {
    return (
        <Box mt="5rem">
            <Box fontSize={80} color="#fff" fontWeight={800} align={'center'}>a <Text fontStyle="italic" display="inline" fontFamily="EB Garamond" >walkthrough</Text> of the platform</Box>
