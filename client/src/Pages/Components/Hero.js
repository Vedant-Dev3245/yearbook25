...
import { VStack, Box, Grid, Text, Image, Flex, HStack } from "@chakra-ui/react";
export default function Hero() {
    return (
        <Box mt="7rem">
            <Flex justifyContent="space-between" alignItems="center">
                <VStack ml="1rem" width="40%" spacing={4} alignItems="baseline">
                    <Text fontSize="5rem" color="white" lineHeight={1.3} fontWeight={800} bgClip="linear(to-l, #7928CA, #FF0080)">
                    ...
                    <Text mt="1rem" fontWeight="600" lineHeight="2rem" fontSize={24} color="#B3B3B3">hey let's make something good for the graduating batch and idk why are you so free and reading this lol jk have fun</Text>
                ...
                <Box>
                    <Box position="relative">
                        <Box bg="rgba(216, 66, 34, 0.25);" p="1rem" color="#B3B3B3" borderRadius="20px" border="2px solid rgba(216, 66, 34, 0.25);" backdropFilter="blur(4px)" boxShadow="0px 0.685535px 16.4528px 0.685535px rgba(0, 0, 0, 0.15)" position="absolute" w="16rem" top="10rem" left="-2rem"><Text>love for pharma grills </Text> <Text> never die. snaps</Text>
                            <Text textAlign="right">~amrit</Text></Box>
                        <Image ml="-1rem" src="../images/Group21.png" alt="yearbook" p={10} />
                    </Box>
                </Box>
            </Flex>
        </Box>
