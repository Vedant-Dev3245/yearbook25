        ...
        <Box mt="10rem">
            ...
            <VStack>
                <Box mt="5rem" border="2px solid #A7D5FF;" boxShadow="0px 0px 10px #2094FF;" borderRadius="1rem" w="80%" color="white" bgColor="rgba(32, 148, 255, 0.15)">
                    <Box ml="3rem" mt="4rem" bgColor="#2094FF" color="white" width="3.5rem" h="3.5rem" borderRadius="50%" textAlign="center"><Text fontSize="1.2rem" transform="translateY(44%)">1</Text></Box>
                    <Flex justifyContent="space-between">
                        <Box w="24%" ml="3rem" mt="1rem">
