            ...
            <Box w="100%" bg="url(./images/textBg.png)" bgRepeat={"no-repeat"} backgroundSize="cover"> 
                <Box background="url(./images/walkBg.png)" backgroundSize="cover" w="72%" h="37rem" borderRadius="50px"
                    ...
                    <Box w='100%' h="37rem">
                        ...
                        <Button display={showVideo === true ? "none" : "block"} cursor="pointer" onClick={toggleVideo} mt="30rem" ml="3rem" p="2rem 2.6rem" borderRadius="200px"> <Image mt="-0.5rem" w="12%" src="./images/playButton.png" /> <Text mt="-1.8rem" fontWeight="800" fontSize="1.6rem" ml="2rem">play video</Text> </Button>
                    </Box>
                </Box>
            </Box>
        </Box >
