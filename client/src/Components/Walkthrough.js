                ...
                <Box background="url(./images/walkBg.png)" backgroundSize="cover" w="80%" h="30rem" borderRadius="50px"
                    ...
                    <Box w='100%' h="30rem">
                        <Box display={showVideo === true ? 'block' : 'none'}>
                            <iframe width="100%" className='video' src="https://www.youtube.com/embed/T94PHkuydcw?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </Box>
