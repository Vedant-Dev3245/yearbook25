            ...
            <Box w="100%" bg="url(./images/textBg.png)" bgRepeat={"no-repeat"} backgroundSize="cover"> 
                <Box background="url(./images/walkBg.png)" backgroundSize="cover" w="72%" borderRadius="50px"
                    ...
                    <Box w='100%'>
                        ...
                        <Button display={showVideo === true ? "none" : "block"} cursor="pointer" onClick={toggleVideo} mt={isSmallerThan800?"10rem":"22rem"} w="fit-content" marginInline={"auto"} marginBottom={"2rem"} p={isSmallerThan800 ? "1rem 1.6rem" : "2rem 2.6rem"} borderRadius="200px"> <Image mt={isSmallerThan800?"0":"-0.5rem"} w={isSmallerThan800?"8%":"13%"} src="./images/playButton.png" /> <Text mt={isSmallerThan800?"-1rem":"-1.8rem"} fontWeight="800" fontSize={isSmallerThan800?"1rem":"1.6rem"} ml="2rem">play video</Text> </Button>
                    </Box>
                </Box>
            </Box>
        </Box >
