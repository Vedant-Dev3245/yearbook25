...
const FAQItems = (props) => {
    ...
    return (
        <Box justifyContent="space-between" pt={5} pl={10} pr={10} pb={5} borderRadius={8} border="3px solid rgba(240, 248, 255, 0.25);" width='90%' onClick={() => props.setFaq(!props.show)} cursor="pointer">
