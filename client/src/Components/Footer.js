...
export default function Footer() {
    ...
    return (
        <>
            <Box color="white" w="80%" marginInline="auto" bg="url('../images/physicalBg.png')" backgroundSize="cover" mt="7rem" className="physical" position="relative">
                <VStack
                    w="80%"
                    marginInline="auto"
                    position="relative"
                    ...
                    border-radius="50px" >
                    <Box fontSize={isSmallerThan800 ? "1.6rem" : "3rem"} fontWeight="700" mt="6rem">opt-in for the <Box display="inline" fontStyle="italic" fontFamily="EB Garamond">physical</Box> yearbook 🥂</Box>
                    ...
                    <Button className="phyButton" marginBottom="6rem !important" fontSize="1.2rem" color="black" fontWeight="700">yes, i do need yearbook irl <ArrowForwardIcon />
                    </Button>
                </VStack>
            </Box>
