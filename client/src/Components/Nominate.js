...
export default function Nominate() {
    return (
        <Box w="90%" marginInline="auto" pb="4rem">
            ...
            <Text mt="3rem" fontSize="1.5rem" fontWeight="800">name</Text>
            <Input marginBlock="1rem" p="1.2rem" placeholder='choose your friend' w="40%" border="1px solid #6C6C6C !important"/>
