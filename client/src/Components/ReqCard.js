...
import { Box, Flex, Text, useMediaQuery, Alert, AlertIcon, Spacer } from "@chakra-ui/react";
    ...
    return (
        ...
        >
            ...
            <Box lineHeight="1.3rem" fontSize="1rem" color="#FFFFFF" fontWeight="400" marginBlock={isSmallerThan800 ? "0.6rem" : "0"} marginInline={isSmallerThan800 ? "0" : "1rem"}>
                has something to write on your wall</Box>
            
            <Flex gap={2}>
            <Flex onClick={handleAcceptReq} borderRadius="50%" bgColor="white" border="1.17225px solid #FFC62D" h="2rem" w="2rem" boxShadow="0px 0px 17.5838px rgba(255, 255, 255, 0.5)" alignItems={"center"} justifyContent="center" >
                <CheckIcon fontSize="1.2rem" cursor="pointer" color="green" />
            </Flex>
            <Spacer/>
            <Flex onClick={handleDeclineReq} borderRadius="50%" bgColor="white" border="1.17225px solid #FFC62D" h="2rem" w="2rem" boxShadow="0px 0px 17.5838px rgba(255, 255, 255, 0.5)" alignItems={"center"} justifyContent="center" >
                <CloseIcon fontSize="1.0rem" cursor="pointer" color="red" />
            </Flex>
            </Flex>
