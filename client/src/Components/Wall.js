...
export default function Wall(props){
    ...
    return(
        ...
        <Box w="90%" marginInline="auto" pb="4rem">
            ...
            {capt.length !==0 && <Box fontSize={isSmallerThan800 ? "1.5rem" : "3rem"} fontWeight="800">your <Text display={"inline"} fontFamily="EB Garamond" fontStyle="italic">frens</Text> have something to say...</Box>}
