        ...
        <Box mt="2rem" className="pad">
            <Flex justifyContent="space-between" alignItems="center" mt={isSmallerThan900 ? "2rem" : 0} flexDirection={isSmallerThan900?"column":"row"}>
                <VStack ml="1rem" width={isSmallerThan900 ? '90%' : '41%'} spacing={4} alignItems={isSmallerThan900 ? 'center' : 'baseline'}>
                    <Text fontSize={isSmallerThan900 ? '2.5rem' : '4.6rem'} color="white" lineHeight={isSmallerThan900?1.1:1.3} fontWeight={800} bgClip="linear(to-l, #7928CA, #FF0080)" textAlign={isSmallerThan900 ? "center" : "left"} >
                        let's make the <br/> <Text display="inline" bg="linear-gradient(97.22deg, #B5D2FF -20.38%, #2094FF 22.55%, #C34FFA 54.73%, #FF6187 86.84%, #F8D548 106.95%);" bgClip="text">yearbook</Text> fun <br/> this time <Image display={'inline'} height={isSmallerThan900?35:59} src="../images/hourglass-not-done_23f3.png"></Image></Text>
                    <Text textAlign={isSmallerThan900 ? "center" : "left"} mt={isSmallerThan900?"2rem !important":"1rem"} fontWeight="600" lineHeight={isSmallerThan900 ? '1.3rem' : '1.7rem'} fontSize={isSmallerThan900 ? '0.9rem' : '1.1rem'} color="#B3B3B3">the yearbook portal is a gateway to your college memories where you can post crazy pictures and interesting captions for yourselves and your friends. it is an effort from our side to help you relive your college life and capture those beautiful memories that you shared with your seniors, batchies and juniors.</Text>
                ...
                <Box marginInline={isSmallerThan900 ? "auto" : "0rem" }>
                    <Box position="relative" className="clockTower" w={isSmallerThan900 ? "100%" : "80%"} marginLeft={isSmallerThan900?"-1rem" : ""} mt={isSmallerThan900 ? "1rem" : 0} >
                        ...
                        <Box className="floatText" bg="rgba(32, 148, 255, 0.5);" fontSize={isSmallerThan900 ? "0.5rem" : "0.8rem"} p={isSmallerThan900 ? "0.2rem" : "0.8rem"} fontWeight="600"  color="#B3B3B3" borderRadius="20px" border="2px solid rgba(32, 148, 255, 0.25);" backdropFilter="blur(4px)" boxShadow="0px 0.58805px 14.1132px 0.58805px rgba(32, 148, 255, 0.25);" position="absolute" w={isSmallerThan900 ? '8rem' : '15rem'} top={isSmallerThan900 ? '14rem' : '28rem'} left={isSmallerThan900 ? '2rem' : '-5rem'}>
