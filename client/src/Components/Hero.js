            ...
            <Flex justifyContent="space-between" alignItems="center" mt={isSmallerThan900 ? "2rem" : 0} flexDirection={isSmallerThan900?"column":"row"}>
                ...
                <Box ml={isSmallerThan900 ? '-1.3rem' : 0} marginInline={"-3rem"}>
                    <Box position="relative" className="clockTower" w="90%" ml={isSmallerThan900 ? "auto" : "0"} mt={isSmallerThan900 ? "1rem" : 0} >
                        ...
                        <Image pointerEvents={'none'} w={isSmallerThan900?"80%":"90%"} src="../images/clock.png" alt="yearbook" p={isSmallerThan900 ? 0 : '2rem'} marginInline="8"/>
                    </Box>
                </Box>
            </Flex >
        </Box >
