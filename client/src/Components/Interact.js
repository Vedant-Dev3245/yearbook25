    ...
    return (
        <Box>
            <Flex  mb="4rem" mt="3rem" w="90%" marginInline={"auto"} justifyContent="flex-start" borderBottom="1px solid rgba(217, 217, 217, 0.1)">
                ...
                <Flex onClick={makeNominActive} cursor="pointer" alignItems="center" p="1rem" className="nomin barItems">
                ...
                <Flex onClick={makeNotifActive} cursor="pointer" alignItems="center" p="1rem" className="notif barItems">
                ...
                <Flex onClick={makeStatsActive} cursor="pointer" alignItems="center" p="1rem" className="stats barItems">
